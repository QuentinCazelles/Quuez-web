...
function nextQuestion(){
    ...
    if(totalQuestions <= 0){
        nextQuestionBtn.innerText = 'Mostrar resultados'
    } 
    initiateClass()
}
...
function displayQuestion(question){
    ...
    questionText.innerText = `Quanto é ${question.question}=???`;
...
function displayResult(){
    ...
    `<span class="option-container total">Total Questões: ${totalQuestions2}</span><span class="option-container correct">Acertos: ${totalMarks}</span><span class="option-container wrong">Errado: ${totalQuestions2-totalMarks}</span>`
